...
model_resnet_trained.load_state_dict(torch.load('../../output/model_resnet50_log_weights.pth'))
model_resnet_trained.to(device)

# Load data from the pickle files
with open('../../output/acc_dict_resnet50_log_weights.pkl', 'rb') as file:
    acc_dict = pickle.load(file)

with open('../../output/loss_dict_resnet50_log_weights.pkl', 'rb') as file:
...
with open('../../output/inference_results/val_preds_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(val_preds_list, f)

with open('../../output/inference_results/val_labels_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(val_labels_list, f)

with open('../../output/inference_results/val_probs_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(val_probs_list, f)

with open('../../output/inference_results/val_accuracy_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(val_accuracy, f)

with open('../../output/inference_results/val_loss_resnet50_log_weights.pkl', 'wb') as f:
...
# # Load data from the pickle files
# with open('../../output/inference_results/val_preds_resnet50_log_weights.pkl', 'rb') as f:
#     val_preds_list = pickle.load(f)

# with open('../../output/inference_results/val_labels_resnet50_log_weights.pkl', 'rb') as f:
#     val_labels_list = pickle.load(f)

# with open('../../output/inference_results/val_probs_resnet50_log_weights.pkl', 'rb') as f:
#     val_probs_list = pickle.load(f)

# with open('../../output/inference_results/val_accuracy_resnet50_log_weights.pkl', 'rb') as f:
#     val_accuracy = pickle.load(f)

# with open('../../output/inference_results/val_loss_resnet50_log_weights.pkl', 'rb') as f:
...
# - - - Save results to files - - -
with open('../../output/inference_results/test_preds_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(test_preds_list, f)

with open('../../output/inference_results/test_labels_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(test_labels_list, f)

with open('../../output/inference_results/test_probs_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(test_probs_list, f)

with open('../../output/inference_results/test_accuracy_resnet50_log_weights.pkl', 'wb') as f:
    pickle.dump(test_accuracy, f)

with open('../../output/inference_results/test_loss_resnet50_log_weights.pkl', 'wb') as f:
...
# # Load data from the pickle files
# with open('../../output/inference_results/test_preds_resnet50_log_weights.pkl', 'rb') as f:
#     test_preds_list = pickle.load(f)

# with open('../../output/inference_results/test_labels_resnet50_log_weights.pkl', 'rb') as f:
#     test_labels_list = pickle.load(f)

# with open('../../output/inference_results/test_probs_resnet50_log_weights.pkl', 'rb') as f:
#     test_probs_list = pickle.load(f)

# with open('../../output/inference_results/test_accuracy_resnet50_log_weights.pkl', 'rb') as f:
#     test_accuracy = pickle.load(f)

# with open('../../output/inference_results/test_loss_resnet50_log_weights.pkl', 'rb') as f:
...
plt.grid(True)
plt.tight_layout()
plt.savefig('../../output/inference_results/model_resnet50_log_weights_auc_roc.png', dpi=300)
plt.show()
...
plt.grid(True)
plt.savefig('../../output/inference_results/model_resnet50_log_weights_prc_ap.png', dpi=300)
plt.show()
